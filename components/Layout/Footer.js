    ...
    <div className="bg-white-300 pt-44 pb-24">
      <div className="max-w-screen-xl w-full mx-auto px-6 sm:px-8 lg:px-16 grid grid-rows-6 sm:grid-rows-1 grid-flow-row sm:grid-flow-col grid-cols-3 sm:grid-cols-12 gap-4">
        ...
        <Image
            ...
            />
          <p className="mb-4">
            <strong className="font-medium">At Shree Hari Interlocks Bricks,</strong>  we are committed to quality and sustainability. Our bricks are manufactured using eco-friendly processes and materials, ensuring that every brick contributes to a greener planet
          </p>
          ...
          <p className="text-gray-400">©{new Date().getFullYear()} - Shreehari Interlock Bricks</p>
        </div>
